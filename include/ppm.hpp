...
void read_ppm(std::istream &file, uint32_t pixels[], size_t *height_ptr, size_t *width_ptr) {
    uint8_t b {}, g {}, r {};
...
void save_ppm(std::ostream &file, uint32_t pixels[], size_t height, size_t width) {
    file << "P6\n" << width << " " << height << "\n255\n";
